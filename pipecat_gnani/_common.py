...
TTS_SUPPORTED_SAMPLE_RATES = (8000, 16000, 22050, 24000, 44100, 48000)
TTS_SUPPORTED_CONTAINERS = frozenset({"raw", "mp3", "wav", "ogg", "mulaw", "alaw"})
SUPPORTED_SAMPLE_RATES = TTS_SUPPORTED_SAMPLE_RATES
