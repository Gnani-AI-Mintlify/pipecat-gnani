...
This will also install the [`gnani-vachana`](https://pypi.org/project/gnani-vachana/) (>= 0.7.9) core SDK as a dependency. The Python import package name remains `gnani`.
